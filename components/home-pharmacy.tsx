...
import { Crown, ShoppingBag, MapPin, Pill, Heart, DiamondPercent, ClipboardList } from 'lucide-react'
...
export function HomePharmacyTemplate() {
              ...
              <div className="flex items-start justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Підвищений кешбек і безкоштовна доставка ліків
                  </p>
                </div>
                <Heart className="w-16 h-16" style={{ color: 'var(--color-accent)' }} />
              </div>
            </Card>
          </Link>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{ backgroundColor: 'color-mix(in srgb, var(--color-accent) 10%, transparent)' }}
                >
                  <Pill className="w-5 h-5" style={{ color: 'var(--color-accent)' }} />
                </div>
                <div className="flex-1">
                  <p className="font-semibold">3 візити</p>
                  <p className="text-xs text-muted-foreground">Відвідувань аптеки</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="font-semibold">62 бали</p>
