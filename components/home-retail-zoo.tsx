...
import { Crown, ShoppingBag, PawPrint, Syringe, MapPin, Tag, DiamondPercent } from 'lucide-react'
...
export function HomeRetailZooTemplate() {
    ...
    <>
      ...
      >
        ...
        <div className="space-y-1">
          ...
          <p className="text-4xl font-bold" style={{ color: 'var(--color-dark)' }}>870 балів</p>
        </div>
      </div>
          ...
          >
            <div className="space-y-4">
              <div>
                ...
                <h3 className="text-2xl font-bold">Pet Friend</h3>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground">Кешбек на корм</span>
                  <span className="font-semibold">7%</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground">Знижка на аксесуари</span>
                  <span className="font-semibold">10%</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground">Знижка у ветклініці</span>
              ...
              <div className="flex items-start justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Ексклюзивні переваги для вас та вашого улюбленця
                  </p>
                </div>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="font-semibold">5 візитів</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="font-semibold">129 балів</p>
